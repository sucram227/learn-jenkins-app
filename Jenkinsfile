pipeline {
    ...
    environment {
        NETLIFY_SITE_ID = 'cd113947-5d92-4f8d-9f51-2da45a62d558'
    ...
    stages {
        ...
        stage('Deploy Staging') {
            ...
            steps {
                sh '''
                    ...
                    echo "Deploing to Staging. Site ID: $NETLIFY_SITE_ID"
        ...
        stage('Deploy Production') {
            ...
            steps {
                sh '''
                    npm install netlify-cli@20.1.1
                    node_modules/.bin/netlify --version
                    echo "Deploing to Production. Site ID: $NETLIFY_SITE_ID"
                    node_modules/.bin/netlify status
        ...
        stage('Production E2E') {
            environment {
                CI_ENVIRONMENT_URL = 'https://jovial-nasturtium-faecb3.netlify.app'
            }
            agent {
                docker {
                    image 'mcr.microsoft.com/playwright:v1.39.0-jammy'
